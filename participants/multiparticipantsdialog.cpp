...
#include "ui_multiparticipantsdialog.h"
#include <QSqlQuery>
#include <QSqlQueryModel>
#include <QStandardItemModel>

MultiParticipantsDialog::MultiParticipantsDialog(Event *event, QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::MultiParticipantsDialog)
{
    ui->setupUi(this);
    ...
    connect(ui->but_add, &QPushButton::clicked, this, &MultiParticipantsDialog::addTn);
    connect(ui->but_del, &QPushButton::clicked, this, &MultiParticipantsDialog::removeTn);
    connect(ui->but_add, &QPushButton::clicked, this, &MultiParticipantsDialog::updateTable);
    connect(ui->but_del, &QPushButton::clicked, this, &MultiParticipantsDialog::updateTable);
    connect(ui->but_save, &QPushButton::clicked, this, &MultiParticipantsDialog::save);
}

MultiParticipantsDialog::~MultiParticipantsDialog()
{
    delete ui;
}

void MultiParticipantsDialog::fillTable()
{
...
void MultiParticipantsDialog::updateTable()
{
    QSqlQuery query3;
    QString query;
...
void MultiParticipantsDialog::addTn()
{
...
void MultiParticipantsDialog::removeTn()
{
...
void MultiParticipantsDialog::save()
{
    for (int i=0;i<lst_int_ids.size();i++) {
        QSqlQuery query20;

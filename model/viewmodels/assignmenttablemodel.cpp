...
AssignmentTableModel::AssignmentTableModel(Event *event, QObject *parent) : QAbstractTableModel(parent) {
    this->riege="";
    this->event = event;
}
...
void AssignmentTableModel::insertRow(QStringList data) {
...
void AssignmentTableModel::setRiege(QString rg) {
    riege = rg;
    setTableData();
}

void AssignmentTableModel::updateRiege(QString rg) {
    riege = rg;

...
void ClubList::print(QPrinter *printer) {
...
void ClubList::printContent() {
    ...
    query2.bindValue(2, this->event->getMainEventId());
    query2.bindValue(3, this->event->getMainEventId());
    query2.exec();
    while (query2.next()) {

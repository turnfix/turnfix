...
#include "../dialogs/points/header/dlg_karte.h"
...
void Tab_PE::startKarte() {
    ...
    query9.bindValue(1,_global::checkHWK());
    query9.bindValue(2,_global::getRunde());
    query9.exec();
    QSqlQuery query2;

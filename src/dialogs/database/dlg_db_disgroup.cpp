...
#include "ui_dlg_db_disgroup.h"
#include "../../global/header/_global.h"

Db_Disgroup_Dialog::Db_Disgroup_Dialog(int im_dgid, QWidget *parent) : QDialog(parent), ui(new Ui::Db_Disgroup_Dialog) {
    dgid = im_dgid;
    ui->setupUi(this);
...
Db_Disgroup_Dialog::~Db_Disgroup_Dialog() {
    delete ui;
}

void Db_Disgroup_Dialog::addItem() {
...
void Db_Disgroup_Dialog::removeItem() {
...
void Db_Disgroup_Dialog::moveUp() {
...
void Db_Disgroup_Dialog::moveDown() {

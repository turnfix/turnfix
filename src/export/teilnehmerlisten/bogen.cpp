#include "header/bogen.h"
#include "../../global/header/_global.h"
#include "../../global/header/settings.h"

bool Bogen::teammode = false;

void Bogen::setTeammode(bool set) {
    teammode = set;
}

void Bogen::printContent() {
    for (int i=0;i<riegenNumbers.size();i++) {
        ...
        erstesGeraet.bindValue(0,_global::checkHWK());
        erstesGeraet.bindValue(1,_global::getRunde());
        ...
        query2.bindValue(4,_global::getRunde());
        for (int j=0;j<disziplinenIDs.size();j++) {
...
void Bogen::printType(QString file,QString name) {
    int off=0;
    QString geraet = name;

#include "header/einzel.h"
#include "../../global/header/_global.h"
#include "../../global/header/result_calc.h"

void Einzel::printContent() {
    for (int i=0;i<wkNumbers.size();i++) {
        ...
        QList<QStringList> rlist = Result_Calc::resultArrayNew(currWK,_global::checkTyp(currWK),vereinNumbers,-1,0,false,detailQuery);
        for (int i=0;i<rlist.size();i++) {
            ...
            QString jg;
            QString verein;
            if (_global::checkTyp(currWK)==0) jg = rlist.at(i).at(3);
            ...
            disCountQuery.bindValue(1,_global::checkHWK());
            disCountQuery.exec();
            QString res;

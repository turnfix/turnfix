#include "header/bericht.h"
#include "../../global/header/_global.h"

void Bericht::print(QPrinter *printer) {
...
void Bericht::printContent() {
    ...
    while (query3.next()) {
        ...
        painter.drawText(QRectF(pr.width()/2, yco, pr.width()-pr.x()-pr.x(), QFontMetricsF(painter.font()).height()),_global::wkBez(query3.value(0).toString()),QTextOption(Qt::AlignVCenter));
        QSqlQuery query4;

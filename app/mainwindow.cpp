...
void MainWindow::showTNDB() {
    MasterdataDialog *dbctrl = new MasterdataDialog(this, 1);
    dbctrl->show();
}

void MainWindow::showVNDB() {
    MasterdataDialog *dbctrl = new MasterdataDialog(this, 2);
    dbctrl->show();
}

void MainWindow::showDisDB() {
    MasterdataDialog *dbctrl = new MasterdataDialog(this, 3);
    dbctrl->show();
}
